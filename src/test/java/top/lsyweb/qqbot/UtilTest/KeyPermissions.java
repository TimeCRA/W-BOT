...
public class KeyPermissions
{
	...
	// 指定群聊
	Integer group = 755926377;
	// 禁止或只开启哪些keyId
//	List<Integer> keyIdArray = Arrays.asList(4, 4, 17, 17, 260, 260); // 游戏王只查卡+今日人品 open
//	List<Integer> keyIdArray = Arrays.asList(17, 17, 314, 1000); // AI聊天相关 open
	List<Integer> keyIdArray = Arrays.asList(17, 17, 260, 260, 314, 1000); // 游戏王查卡 + AI聊天相关 open
